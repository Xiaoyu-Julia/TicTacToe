...
//        setSymbolToPlayerChoice(firstPlayer, secondPlayer);
//        tictactoeUser.setSymbolToFirstPlayer(firstPlayer);
//        System.out.println("firstPlayer = " + this.firstPlayer);
//
//        tictactoeUser.setSymbolToSecondPlayer(secondPlayer);
//        System.out.println("secondPlayer = " + this.secondPlayer);
